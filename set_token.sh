#!/bin/sh
# replace `pk.YOUR_ACCESS_TOKEN`` with contents of ./accesstoken in ./ios/rnmbxnavigation_rn71demo/Info.plist files ./android/app/src/main/AndroidManifest.xml
...
FILES=(ios/rnmbxnavigation_rn71demo/Info.plist android/app/src/main/AndroidManifest.xml)
